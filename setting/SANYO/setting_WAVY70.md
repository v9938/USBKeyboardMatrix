# SANYO WAVY70FD/70FD2用サブユニット取り付け方法  

## 取り付け位置

<img src="./img/img_wavy70_00.jpg" width="100%" />　　

### キーボード端子
サブモジュール下に半田パッドがあるため、平らにセットができません。  
テープによる絶縁処理を忘れず実施してください。    
<img src="./img/img_wavy70_01.jpg" width="100%" />　　

### その他配線箇所
+5VとGNDの配線が必要です。  
<img src="./img/img_wavy70_02.jpg" width="100%" />　　

PAUSEキー対応する場合は下記配線が必要です。(オプション)    
<img src="./img/img_wavy70_03.jpg" width="100%" />　　

### メインユニット固定位置  
キーボード端子近辺   

本機種は構造上シールドケースに挟み込んでケーブルを引き出す必要があります。  
絶縁テープなどFFCケーブルを保護するようにしてください。  
