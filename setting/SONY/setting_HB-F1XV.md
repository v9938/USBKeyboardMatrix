# SONY HB-F1XD/XDmk2/XDJ/XV用サブユニット取り付け方法  

## 取り付け位置

### キーボード端子
サブモジュール下に半田パッドがあるため、平らにセットができません。  
テープによる絶縁処理を忘れず実施してください。    
<img src="./img/img_hb-f1xv_01.jpg" width="100%" />　　

### その他配線箇所
CAPS/カナLEDに対応する場合は下記配線が必要です。(オプション)    
<img src="./img/img_hb-f1xv_02.jpg" width="100%" />　　

### メインユニット固定位置  
FDDユニット近辺 または キーボード下近辺   

取り付け時にシールド板でケーブルを切断しないように注意してください。  
特にシールドケースに挟み込んでケーブルを引き出す場合は、絶縁テープなどで保護するようにしてください。  
<img src="./img/img_hb-f1xv_04.jpg" width="100%" />
